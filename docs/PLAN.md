...
| Avisar por WhatsApp a la pastoral | Un botón junto a cada integrante —tenga ficha en el equipo o esté solo con su nombre y su teléfono a mano— abre la conversación con el mensaje ya escrito; el texto se teclea una vez arriba del listado y lo llevan todos. Son enlaces `wa.me`, no la API de Meta: sin costo, sin trámite y sin llamadas salientes. Requiere el permiso nuevo `personas.contactar` | Petición de la parroquia |
| Validación de teléfonos al capturar | Los trece campos de teléfono del panel y del sitio exigen diez dígitos —con espacios, guiones o paréntesis, como se quiera— o el número de otro país con `+` y su clave; cualquier letra los invalida, que es lo que atrapaba la extensión pegada al número. Se comprobó que ninguno de los teléfonos ya guardados queda fuera de la regla | Hueco que dejó a la vista el botón de WhatsApp |
