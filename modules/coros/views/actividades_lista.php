<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
    <div>
        <h1 class="h4 fw-bold mb-1">Actividades</h1>
        <p class="text-muted mb-0 small">Ensayos, celebraciones y todo lo que la pastoral tiene con fecha.</p>
    </div>
    <div class="d-flex flex-wrap gap-2">
        <?php $navActiva = 'actividades'; require __DIR__ . '/_nav.php'; ?>
    </div>
</div>

<?php /* Sin aviso de "esta lista se ve también en tal sitio", a diferencia de
         Documentos: `pastoral_tablero` es una tabla por pastoral y no por
         módulo, pero cada módulo dedicado muestra la suya y el panel básico de
         la pastoral todavía no ofrece esta pantalla. El día que la ofrezca,
         este aviso hace falta aquí igual que en Documentos. */ ?>
    ...
    <div class="modal fade" id="<?= e($idModal) ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" accept-charset="UTF-8"
                  action="<?= e(url_post('admin', 'coros', 'actividad_guardar')) ?>" class="modal-content">
                ...
                <div class="modal-footer border-0 justify-content-between">
                    ...
                    <button type="submit" formaction="<?= e(url_post('admin', 'coros', 'actividad_eliminar')) ?>"
