...
<?php /* Sin aviso de "esta lista se ve también en tal sitio", a diferencia de
         ...
         módulo, pero hoy este módulo y el de Catequesis son los dos únicos
         sitios que la muestran, cada uno la suya. El panel básico de la
         pastoral todavía no la ofrece. */ ?>
    ...
    <div class="modal fade" id="<?= e($idModal) ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" accept-charset="UTF-8"
                  action="<?= e(url_post('admin', 'proclamadores', 'actividad_guardar')) ?>" class="modal-content">
                ...
                <div class="modal-footer border-0 justify-content-between">
                    ...
                    <button type="submit" formaction="<?= e(url_post('admin', 'proclamadores', 'actividad_eliminar')) ?>"
