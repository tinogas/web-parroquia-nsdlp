<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
    <div>
        ...
        <p class="text-muted mb-0 small">Material descargable: leccionario, guías y formatos.</p>
    </div>
    ...
    <div class="card-body p-4">
        ...
        <ul class="list-group list-group-flush mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                ...
                <?php if (Auth::tienePermiso('proclamadores.eliminar')): ?>
                <form method="POST" accept-charset="UTF-8"
                      action="<?= e(url_post('admin', 'proclamadores', 'documento_eliminar')) ?>" class="m-0"
...
<div class="modal fade" id="documentoNuevo" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form method="POST" accept-charset="UTF-8" enctype="multipart/form-data"
              action="<?= e(url_post('admin', 'proclamadores', 'documento_guardar')) ?>" class="modal-content">
            <input type="hidden" name="_csrf" value="<?= e($csrf) ?>">
